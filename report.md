...
<p>In regards to cooperation between team members, everything generally went smoothly, with most team members completing their assigned tasks in a timely manner and checking teams on a regular basis.</p>
  <p>As mentioned previously, a teams chat was established for developers to update eachother on their progress; this soon became a way for team members to ask for and provide help with certain sections of code, as well as to suggest improvements to other people's code.</p>
    <p>However, we did encounter some issues with a team member failing to communicate or participate fully in the project.  We reached out to this team member on multiple occasions, keeping the line of communication open with summaries of any meetings that they missed so that they could quickly reintegrate into the project if they wanted to.  Unfortunately, with the deadline rapidly approaching and no communication from this team member for over a week, we had to make the hard decision to reassign the remaining sections of their code to another developer.  Even in doing so, we attempted to practice good communication, reaching out to the team member again to explain our decision.</p>
